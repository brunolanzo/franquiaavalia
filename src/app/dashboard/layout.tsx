...
import { LayoutDashboard, Star, User, Building2, Menu, X, MessageSquare } from "lucide-react";

const navItems = [
  { href: "/dashboard", label: "Visão Geral", icon: LayoutDashboard },
  { href: "/dashboard/minha-franquia", label: "Minhas Franquias", icon: Building2 },
  { href: "/dashboard/avaliar", label: "Avaliar Franquia", icon: Star },
  { href: "/dashboard/avaliacoes", label: "Minhas Avaliações", icon: MessageSquare },
