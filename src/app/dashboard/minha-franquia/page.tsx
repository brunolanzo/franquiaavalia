...
export default function MinhaFranquiaPage() {
  ...
  if (role !== "FRANCHISEE" && role !== "ADMIN") {
    return (
      <div className="mx-auto max-w-2xl">
        <h1 className="mb-6 text-2xl font-bold text-gray-900">Minhas Franquias</h1>
  ...
  return (
    <div className="mx-auto max-w-2xl">
          ...
          <div className="p-6">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#F59E0B] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#D97706] transition-colors"
              >
      ...
      {/* Buscar e vincular outra franquia */}
